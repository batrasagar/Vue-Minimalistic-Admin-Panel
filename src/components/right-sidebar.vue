    ...
    <div v-click-outside="config" class="right-bar">
      <div data-simplebar class="h-100">
        ...
        <div class="p-4">
          <div class="mb-2">
            <router-link
              to="//http://Jet66ERP.vuejs-light-h.curtina technologies.in/"
              target="_blank"
            >
              <img
          ...
          <div class="mb-2">
            <router-link
              to="//http://Jet66ERP.vuejs-dark-h.curtina technologies.in/"
              target="_blank"
            >
              <img
          ...
          <div class="mb-2">
            <router-link
              to="//http://Jet66ERP.vuejs-rtl-h.curtina technologies.in/"
              target="_blank"
            >
              <img
